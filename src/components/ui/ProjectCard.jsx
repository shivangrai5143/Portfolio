...
const ProjectCard = ({ project, index = 0 }) => {
  const { title, description, image, techStack, githubUrl, liveUrl, featured, stars, forks } = project;
    ...
    >
      ...
      <div className="flex flex-col flex-1 p-6 gap-4">
        ...
        <p className="text-gray-600 dark:text-slate-400 text-sm leading-relaxed line-clamp-3 flex-1">
          {description || 'A project showcasing technical skills and problem-solving abilities.'}
        </p>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {techStack.length > 5 && (
            <span className="text-[10px] text-gray-500 self-center">+{techStack.length - 5} more</span>
          )}
        </div>
