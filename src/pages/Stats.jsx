...
const useCounter = (target, duration = 1800, shouldStart = false) => {
...
// ── Stat card ──────────────────────────────────────────────────────────────
const StatCard = ({ icon: Icon, color, bgColor, value, suffix, label, delay, shouldStart, isLoading }) => {
  ...
  const stats = [
    {
      ...
      // Use live GitHub repo count if available, otherwise fallback
    ...
    },
    {
      ...
      // Use detected tech stack length if available
  ...
  return (
    <div className="relative bg-gray-50 dark:bg-slate-950 py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/4 w-80 h-80 bg-blue-600/8 rounded-full blur-[100px]" />
